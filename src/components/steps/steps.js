        ...
        <ol className="grid grid-cols-1 divide-x divide-gray-100 overflow-hidden rounded-lg border border-gray-100 text-sm text-gray-500 sm:grid-cols-3">
          <li className="flex items-center justify-center p-4">
            ...
            <p className="leading-none">
              ...
              <small className="mt-1"> How KYC/AML is done on-chain </small>
            </p>
          </li>

          <li className="relative flex items-center justify-center bg-gray-200 p-4">
            ...
            <p className="leading-none">
              <strong className="block font-medium"> Tokenization </strong>
              <small className="mt-1"> What it is. How to do it. </small>
            </p>
          </li>
          ...
          <li className="flex items-center justify-center p-4">
            ...
            <p className="leading-none">
              <strong className="block font-medium"> Trading </strong>
              <small className="mt-1"> Where to do it. </small>
            </p>
          </li>
          <li className="relative flex items-center justify-center bg-gray-200 p-4">
            <span className="absolute -left-2 top-1/2 hidden h-4 w-4 -translate-y-1/2 rotate-45 border border-b-0 border-l-0 border-gray-100 bg-white sm:block"></span>
